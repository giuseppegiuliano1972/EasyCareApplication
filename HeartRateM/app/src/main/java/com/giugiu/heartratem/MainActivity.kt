...
import com.giugiu.heartratem.ui.components.HealthConnectProblemsBanner
import com.giugiu.heartratem.ui.theme.HeartRateMTheme
import com.giugiu.heartratem.ui.viewmodels.ExporterBackgroundWorkViewModel
import com.giugiu.heartratem.ui.viewmodels.WORK_NAME_ONCE
...
fun ExportDestinationInputField() {
    ...
    TextField(enabled = fieldValue != null,
        placeholder = { Text("URI destinazione") },
...
fun RequestPermissionButton() {
    ...
    Button(
        ...
        Text(text = "Permessi di Notifica")
    }
}
...
fun RequestHealthConnectPermissionButton() {
    ...
    Button(
        ...
        Text(text = "Permessi Health Connect")
    }
}
